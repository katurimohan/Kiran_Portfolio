...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: '#64748b', fontSize: '0.75rem', fontWeight: 500, letterSpacing: 2, textTransform: 'uppercase' }}>Scroll</span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
        ...
        >
          <div style={{ width: 3, height: 8, borderRadius: 3, background: '#3b82f6' }} />
        </motion.div>
      </motion.div>
